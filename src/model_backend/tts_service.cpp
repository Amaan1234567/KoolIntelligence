...
{
    system(("voice_out -p "+std::string("\""+text+"\"")+" -m "+std::string(getenv("HOME"))+"/koolintelligence/models/ggml_weights_q4.bin -o "+std::string(getenv("HOME"))+"/koolintelligence/voice_out.wav"+" -t 8 -s 60").c_str());
